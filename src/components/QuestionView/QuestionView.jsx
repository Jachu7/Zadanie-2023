                ...
                <div className="col-12 p-0">
                    ...
                    >
                        <form onSubmit={formPreventDefault}>
                            ...
                            >
                                ...
                                <div className="Q-input">
                                    <input
                                        ...
                                        placeholder={`Title of the question group-${
                                            id + 1
                                        }`}
                                    />
                                </div>
                            ...
                            <div
                                className={`pdl pdr pb-4 ${toggleClass} addcat`}
                            >
                                <AddCategory onClick={handlecViewClick} />
                                <div>
                                    {/* Create Drag and drop functionality here like in App.jsx but show cviews here */}
                                    <DragDropContext
